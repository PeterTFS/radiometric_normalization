########################################################################################
#Need to preprocess the reference and candidate image to make them an equally in shape
#Method1,use gdal to create a overlapping rectangle to clip both of the candidate and reference image
#Method2. check arosics to see if there are some existing function to get the overlapping area
#Updated 04-27-2018
...
##
Target:
S2A_MSIL2A_T14RMS_N0204_20170209_0_M_10m.tif
S2A_MSIL2A_T14RNS_N0204_20170209_0_M_10m.tif

Reference: 
S2A_MSIL2A_T14RMS_N0204_20170130_10m.tif
S2A_MSIL2A_T14RNS_N0204_20170130_10m.tif

Output:
S2A_MSIL2A_T14RMS_N0204_20170209_0_M_R_10m.tif
S2A_MSIL2A_T14RNS_N0204_20170209_0_M_R_10m.tif
"""
#candidate_path = os.path.join(WorkSpace, full_candidate_name)
wd_local = r"C:\\DEV\\FuelMapping\\Multiband_Images\\T14RMS_T14RNS"
wd_sync = r"C:\\Users\\pyang\\Syncplicity Folder\\FuelMapping\\Multiband_Images\\T14RMS_T14RNS"
candidate_fn = 'S2A_MSIL2A_T14RMS_N0204_20170209_0_M_10m_clip.tif'
reference_fn = 'S2A_MSIL2A_T14RMS_N0204_20170130_10m_clip.tif'

pairTupeleList = [('S2A_MSIL2A_T14RMS_N0204_20170209_0_M_10m_clip.tif','S2A_MSIL2A_T14RMS_N0204_20170130_10m_clip.tif'), 
                   ('S2A_MSIL2A_T14RNS_N0204_20170209_0_M_10m_clip.tif', 'S2A_MSIL2A_T14RNS_N0204_20170130_10m_clip.tif')]
##second run
# candidate_fn = 'S2A_MSIL2A_T14RNS_N0204_20170209_0_M_10m_clip.tif'
# reference_fn = 'S2A_MSIL2A_T14RNS_N0204_20170130_10m_clip.tif'
for pt in pairTupeleList:
    candidate_fn, reference_fn = pt
    print candidate_fn,reference_fn
